        ...
        <form action="<?php echo $action; ?>" method="post">
			...
			<div class="input-group">
				<div class="col-md-12">
					...
					<textarea rows="1" id="Address2" name="Address2" class="form-control"><?=set_value('', $Address2)?></textarea>
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-12">
					<label for="Address3" class="col-form-label">City/Country <?php echo form_error('Address3') ?></label>
					<textarea rows="1" id="Address3" name="Address3" class="form-control"><?=set_value('', $Address3)?></textarea>
				</div>
			</div>
			...
			<div class="input-group">
				<div class="col-md-12">
					<label for="Des1" class="col-form-label">HS Code <?php echo form_error('Des1') ?></label>
					<textarea rows="1" id="Des1" name="Des1" class="form-control"><?=set_value('', $Des1)?></textarea>	
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-12">
					<label for="Des2" class="col-form-label">Unit / Weight <?php echo form_error('Des2') ?></label>
					<textarea rows="1" id="Des2" name="Des2" class="form-control"><?=set_value('', $Des2)?></textarea>	
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-12">
					<label for="Des3" class="col-form-label">Variant <?php echo form_error('Des3') ?></label>
					<textarea rows="1" id="Des3" name="Des3" class="form-control"><?=set_value('', $Des3)?></textarea>	
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-12">
					<label for="Des4" class="col-form-label">Purpose<?php echo form_error('Des4') ?></label>
					<textarea rows="1" id="Des4" name="Des4" class="form-control"><?=set_value('', $Des4)?></textarea>	
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-12">
					<label for="Des5" class="col-form-label">Chassis No.<?php echo form_error('Des5') ?></label>
					<textarea rows="1" id="Des5" name="Des5" class="form-control"><?=set_value('', $Des5)?></textarea>	
				</div>
			</div>

			<div class="input-group">
				<div class="col-md-6">
					<label for="GrossWeight1" class="col-form-label">Gross Weight <?php echo form_error('GrossWeight1') ?></label>
					<input type="text" autocomplete="off" class="form-control" name="GrossWeight1" id="GrossWeight1" value="<?php echo $GrossWeight1; ?>" />
				</div>

				<div class="col-md-6">
					<label for="GrossWeight2" class="col-form-label">Quantity  <?php echo form_error('GrossWeight2') ?></label>
					<input type="text" autocomplete="off" class="form-control" name="GrossWeight2" id="GrossWeight2" value="<?php echo $GrossWeight2; ?>" />
				</div>
				
				<div class="col-md-6">
					<label for="GrossWeight3" class="col-form-label">Value<?php echo form_error('GrossWeight3') ?></label>
					<input type="text" autocomplete="off" class="form-control" name="GrossWeight3" id="GrossWeight3" value="<?php echo $GrossWeight3; ?>" />
				</div>
