    ...
    <li class="breadcrumb-item active" aria-current="page">Entry</li>
		...
		<div class="input-group mb-3">
				<div class="col-md-4">
					...
					<input type="text" maxlength="15" class="form-control" name="RefNo" id="RefNo" value="<?php echo $RefNo; ?>" />
				</div>
				<div class="col-md-4">
					<label for="RefCode" class="col-form-label">Reference Code <?php echo form_error('RefCode') ?></label>
					<input type="text" maxlength="9" class="form-control" name="RefCode" id="RefCode" value="<?php echo $RefCode; ?>" />
				</div>
				<div class="col-md-4">
					<label for="varchar" class="col-form-label">Issued In <?php echo form_error('IssuedIn') ?></label>
					<input type="text" class="form-control" name="IssuedIn" id="IssuedIn" value="<?php echo $IssuedIn; ?>" />
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-12">
					...
					<input type="text" class="form-control" name="GoodsConsignedFrom" id="GoodsConsignedFrom" value="<?php echo $GoodsConsignedFrom; ?>" />
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-12">
					...
					<textarea rows="2" id="Address1" name="Address1" class="form-control"><?=set_value('', $Address1)?></textarea>	
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-12">
					...
					<input type="text" class="form-control" name="GoodsConsignedTo" id="GoodsConsignedTo" value="<?php echo $GoodsConsignedTo; ?>" />
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-12">
					...
					<textarea rows="2" id="Address2" name="Address2" class="form-control"><?=set_value('', $Address2)?></textarea>	
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-4">
					...
					<input type="text" class="form-control" name="VesselName" id="VesselName" value="<?php echo $VesselName; ?>" />
				</div>
				<div class="col-md-4">
					<label for="PortOfLoading" class="col-form-label">Port of Loading <?php echo form_error('PortOfLoading') ?></label>
					<input type="text" class="form-control" name="PortOfLoading" id="PortOfLoading" value="<?php echo $PortOfLoading; ?>" />
				</div>	
				<div class="col-md-4">
					<label for="PortOfDischarge" class="col-form-label">Port of Discharge <?php echo form_error('PortOfDischarge') ?></label>
					<input type="text" class="form-control" name="PortOfDischarge" id="PortOfDischarge" value="<?php echo $PortOfDischarge; ?>" />
				</div>
			</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-3">
					...
					<input data-date-today-highlight="true" data-provide="datepicker" type="text" class="DatePicker form-control" name="DepartureDate" id="DepartureDate" value="<?php echo $DepartureDate; ?>" />
				</div>
				<div class="col-md-3">
					<label for="ItemNumber" class="col-form-label">Item Number <?php echo form_error('ItemNumber') ?></label>
					<input type="number" class="form-control" name="ItemNumber" id="ItemNumber" value="<?php echo $ItemNumber; ?>" />
				</div>

				<div class="col-md-3">
					<label for="NumberPackage" class="col-form-label">Number of Package <?php echo form_error('NumberPackage') ?></label>
					<input type="text" class="form-control" name="NumberPackage" id="NumberPackage" value="<?php echo $NumberPackage; ?>" />
				</div>
				<div class="col-md-3">
					<label for="OriginCriterion" class="col-form-label">Origin Criterion <?php echo form_error('OriginCriterion') ?></label>
					<input type="text" class="form-control" name="OriginCriterion" id="OriginCriterion" value="<?php echo $OriginCriterion; ?>" />
				</div>
			</div>
			...
			<div class="input-group mb-3">
				...
				<div class="col-md-4">
					...
					<input type="text" class="form-control" name="ImportingCountry" id="ImportingCountry" value="<?php echo $ImportingCountry; ?>" />
				</div>
			...
			<div class="input-group mb-3">
				<div class="col-md-4">
					...
					<input type="text" data-date-today-highlight="true" data-provide="datepicker" class="DatePicker form-control" name="Date" id="Date" value="<?php echo $Date; ?>" />
				</div>
				<div class="col-md-4">
					<label for="Sign" class="col-form-label">Sign <?php echo form_error('Sign') ?></label>
					<input type="text" class="form-control" name="Sign" id="Sign" value="<?php echo $Sign; ?>" />
				</div>
				<div class="col-md-4" class="col-form-label">
					<label for="CertDateStamp" class="col-form-label">Certification Date (Stamp) <?php echo form_error('CertDateStamp') ?></label>
					<input type="text" data-date-today-highlight="true" data-provide="datepicker" class="DatePicker form-control" name="CertDateStamp" id="CertDateStamp" value="<?php echo $CertDateStamp; ?>" />
				</div>
			</div>
